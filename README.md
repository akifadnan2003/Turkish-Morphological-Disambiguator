...
| Dashboard & Stats | Visual POS Analysis |
|:-:|:-:|
| ![Dashboard](report/screenshots/01_dashboard_overview.png) | ![Analysis](report/screenshots/02_analysis_result.png) |

| CoNLL-U Output | Confusion Matrix & F1 Chart |
|:-:|:-:|
| ![CoNLL-U](report/screenshots/03_conllu_output.png) | ![Charts](report/screenshots/05_manual_annotations.png) |

![Manual Annotations](report/screenshots/04_per_class_metrics.png)
*25 manually annotated sentences — green = correct prediction, red = wrong*
